...
var ASM_CONSTS = {
  126799: () => { if (document.fullscreenElement) return 1; },  
 126845: () => { return Module.canvas.width; },  
 126877: () => { return parseInt(Module.canvas.style.width); },  
 126925: () => { document.exitFullscreen(); },  
 126952: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 127025: () => { if (document.fullscreenElement) return 1; },  
 127071: () => { return Module.canvas.width; },  
 127103: () => { return screen.width; },  
 127128: () => { document.exitFullscreen(); },  
 127155: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 127288: () => { return window.innerWidth; },  
 127314: () => { return window.innerHeight; },  
 127341: () => { if (document.fullscreenElement) return 1; },  
 127387: () => { return Module.canvas.width; },  
 127419: () => { return parseInt(Module.canvas.style.width); },  
 127467: () => { if (document.fullscreenElement) return 1; },  
 127513: () => { return Module.canvas.width; },  
 127545: () => { return screen.width; },  
 127570: () => { return window.innerWidth; },  
 127596: () => { return window.innerHeight; },  
 127623: () => { if (document.fullscreenElement) return 1; },  
 127669: () => { return Module.canvas.width; },  
 127701: () => { return screen.width; },  
 127726: () => { document.exitFullscreen(); },  
 127753: () => { if (document.fullscreenElement) return 1; },  
 127799: () => { return Module.canvas.width; },  
 127831: () => { return parseInt(Module.canvas.style.width); },  
 127879: () => { document.exitFullscreen(); },  
 127906: ($0) => { Module.canvas.style.opacity = $0; },  
 127944: () => { return screen.width; },  
 127969: () => { return screen.height; },  
 127995: () => { return window.screenX; },  
 128022: () => { return window.screenY; },  
 128049: () => { return window.devicePixelRatio; },  
 128085: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 128138: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 128189: () => { Module.canvas.style.cursor = 'none'; },  
 128226: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 128482: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 128533: () => { if (document.fullscreenElement) return 1; },  
 128579: () => { return window.innerWidth; },  
 128605: () => { return window.innerHeight; },  
 128632: () => { if (document.pointerLockElement) return 1; }
};
function get_my_sentence() { var jsString = 'whats 8+8'; return stringToNewUTF8(jsString); }
...
var _ask_gpt = Module['_ask_gpt'] = makeInvalidEarlyAccess('_ask_gpt');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_ask_gpt'] = _ask_gpt = createExportWrapper('ask_gpt', 1);
