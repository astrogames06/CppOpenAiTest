...
var ASM_CONSTS = {
  118703: () => { if (document.fullscreenElement) return 1; },  
 118749: () => { return Module.canvas.width; },  
 118781: () => { return parseInt(Module.canvas.style.width); },  
 118829: () => { document.exitFullscreen(); },  
 118856: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 118929: () => { if (document.fullscreenElement) return 1; },  
 118975: () => { return Module.canvas.width; },  
 119007: () => { return screen.width; },  
 119032: () => { document.exitFullscreen(); },  
 119059: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 119192: () => { return window.innerWidth; },  
 119218: () => { return window.innerHeight; },  
 119245: () => { if (document.fullscreenElement) return 1; },  
 119291: () => { return Module.canvas.width; },  
 119323: () => { return parseInt(Module.canvas.style.width); },  
 119371: () => { if (document.fullscreenElement) return 1; },  
 119417: () => { return Module.canvas.width; },  
 119449: () => { return screen.width; },  
 119474: () => { return window.innerWidth; },  
 119500: () => { return window.innerHeight; },  
 119527: () => { if (document.fullscreenElement) return 1; },  
 119573: () => { return Module.canvas.width; },  
 119605: () => { return screen.width; },  
 119630: () => { document.exitFullscreen(); },  
 119657: () => { if (document.fullscreenElement) return 1; },  
 119703: () => { return Module.canvas.width; },  
 119735: () => { return parseInt(Module.canvas.style.width); },  
 119783: () => { document.exitFullscreen(); },  
 119810: ($0) => { Module.canvas.style.opacity = $0; },  
 119848: () => { return screen.width; },  
 119873: () => { return screen.height; },  
 119899: () => { return window.screenX; },  
 119926: () => { return window.screenY; },  
 119953: () => { return window.devicePixelRatio; },  
 119989: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 120042: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 120093: () => { Module.canvas.style.cursor = 'none'; },  
 120130: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 120386: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 120437: () => { if (document.fullscreenElement) return 1; },  
 120483: () => { return window.innerWidth; },  
 120509: () => { return window.innerHeight; },  
 120536: () => { if (document.pointerLockElement) return 1; }
};
